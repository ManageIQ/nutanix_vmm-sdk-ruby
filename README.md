...
```shell
gem install ./nutanix_vmm-0.2.2.gem
```

(for development, run `gem install --dev ./nutanix_vmm-0.2.2.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'nutanix_vmm', '~> 0.2.2'
...
*NutanixVmm::StatsApi* | [**get_disk_stats_by_id**](docs/StatsApi.md#get_disk_stats_by_id) | **GET** /vmm/v4.0/ahv/stats/vms/{vmExtId}/disks/{extId} | Get the stats for the specified VM disk
*NutanixVmm::StatsApi* | [**get_nic_stats_by_id**](docs/StatsApi.md#get_nic_stats_by_id) | **GET** /vmm/v4.0/ahv/stats/vms/{vmExtId}/nics/{extId} | Get the stats for the specified VM NIC
*NutanixVmm::StatsApi* | [**get_vm_stats_by_id**](docs/StatsApi.md#get_vm_stats_by_id) | **GET** /vmm/v4.0/ahv/stats/vms/{extId} | Get VM stats for a given VM
*NutanixVmm::StatsApi* | [**list_vm_stats**](docs/StatsApi.md#list_vm_stats) | **GET** /vmm/v4.0/ahv/stats/vms | List VM stats for all VMs
...
*NutanixVmm::VmApi* | [**assign_vm_owner**](docs/VmApi.md#assign_vm_owner) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/assign-owner | Assign owner of a VM
*NutanixVmm::VmApi* | [**associate_categories**](docs/VmApi.md#associate_categories) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/associate-categories | Associate categories to a VM
...
*NutanixVmm::VmApi* | [**disassociate_categories**](docs/VmApi.md#disassociate_categories) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/disassociate-categories | Disassociate categories from a VM
...
*NutanixVmm::VmApi* | [**get_vm_by_id**](docs/VmApi.md#get_vm_by_id) | **GET** /vmm/v4.0/ahv/config/vms/{extId} | Get VM configuration details
...
*NutanixVmm::VmApi* | [**list_vms**](docs/VmApi.md#list_vms) | **GET** /vmm/v4.0/ahv/config/vms | List VMs
...
*NutanixVmm::VmApi* | [**power_off_vm**](docs/VmApi.md#power_off_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/power-off | Force power off a VM
*NutanixVmm::VmApi* | [**power_on_vm**](docs/VmApi.md#power_on_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/power-on | Turn on a VM
*NutanixVmm::VmApi* | [**reboot_guest_vm**](docs/VmApi.md#reboot_guest_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/guest-reboot | Restart the VM using NGT
...
*NutanixVmm::VmApi* | [**reset_vm**](docs/VmApi.md#reset_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/reset | Reset a VM immediately
*NutanixVmm::VmApi* | [**revert_vm**](docs/VmApi.md#revert_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/revert | Revert the AHV VM.
*NutanixVmm::VmApi* | [**shutdown_guest_vm**](docs/VmApi.md#shutdown_guest_vm) | **POST** /vmm/v4.0/ahv/config/vms/{extId}/$actions/guest-shutdown | Shutdown the VM using NGT
