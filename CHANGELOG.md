...
## [0.2.3] - 2026-04-30
# Fixed
- Drop docs from published gem ([#29](https://github.com/ManageIQ/nutanix_vmm-sdk-ruby/pull/29))

# Changed
- Update peter-evans/create-pull-request action to v8 ([#23](https://github.com/ManageIQ/nutanix_vmm-sdk-ruby/pull/23))
- Various actions updates ([#22](https://github.com/ManageIQ/nutanix_vmm-sdk-ruby/pull/22))
...
[Unreleased]: https://github.com/ManageIQ/nutanix_vmm-sdk-ruby/compare/v0.2.3...HEAD
[0.2.3]: https://github.com/ManageIQ/nutanix_vmm-sdk-ruby/compare/v0.2.2...v0.2.3
