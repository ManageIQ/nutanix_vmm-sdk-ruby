...
module NutanixVmm
  ...
  class VmmV40AhvConfigPcieDevice < ApiModelBase
    ...
    attr_accessor :assigned_device_info
    ...
    def self.openapi_types
      {
        ...
        :'assigned_device_info' => :'VmmV40AhvConfigPcieDeviceInfo',
        :'backing_info' => :'VmmV40AhvConfigPcieDeviceReference'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvConfigPcieDevice` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvConfigPcieDevice`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assigned_device_info')
        self.assigned_device_info = attributes[:'assigned_device_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ext_id == o.ext_id &&
          links == o.links &&
          assigned_device_info == o.assigned_device_info &&
    ...
    def hash
      [tenant_id, ext_id, links, assigned_device_info, backing_info].hash
    end
