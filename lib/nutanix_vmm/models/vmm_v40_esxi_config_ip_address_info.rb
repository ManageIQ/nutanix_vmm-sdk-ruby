...
module NutanixVmm
  ...
  class VmmV40EsxiConfigIpAddressInfo < ApiModelBase
    ...
    def self.openapi_types
      {
        :'ipv4_addresses' => :'Array<CommonV10ConfigIPv4Address>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40EsxiConfigIpAddressInfo` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40EsxiConfigIpAddressInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@ipv4_addresses.nil? && @ipv4_addresses.length > 128
        invalid_properties.push('invalid value for "ipv4_addresses", number of items must be less than or equal to 128.')
      end
      ...
      if !@ipv6_addresses.nil? && @ipv6_addresses.length > 128
        invalid_properties.push('invalid value for "ipv6_addresses", number of items must be less than or equal to 128.')
      end
    ...
    def valid?
      ...
      return false if !@ipv4_addresses.nil? && @ipv4_addresses.length > 128
      return false if !@ipv4_addresses.nil? && @ipv4_addresses.length < 0
      return false if !@ipv6_addresses.nil? && @ipv6_addresses.length > 128
    ...
    def ipv4_addresses=(ipv4_addresses)
      ...
      if ipv4_addresses.length > 128
        fail ArgumentError, 'invalid value for "ipv4_addresses", number of items must be less than or equal to 128.'
      end
    ...
    def ipv6_addresses=(ipv6_addresses)
      ...
      if ipv6_addresses.length > 128
        fail ArgumentError, 'invalid value for "ipv6_addresses", number of items must be less than or equal to 128.'
      end
    ...
    def hash
      [ipv4_addresses, ipv6_addresses].hash
    end
