  ...
  class VmmV40ContentTemplateVersionSpec
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40ContentTemplateVersionSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@version_description.nil? && @version_description.to_s.length < 1
        invalid_properties.push('invalid value for "version_description", the character length must be great than or equal to 1.')
      end
    ...
    def version_description=(version_description)
      ...
      if version_description.to_s.length < 1
        fail ArgumentError, 'invalid value for "version_description", the character length must be great than or equal to 1.'
      end
