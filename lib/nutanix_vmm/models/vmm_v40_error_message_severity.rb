...
module NutanixVmm
  class VmmV40ErrorMessageSeverity
    INFO = "INFO".freeze
    ...
    def build_from_hash(value)
      return value if VmmV40ErrorMessageSeverity.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40ErrorMessageSeverity"
    end
  end
end
