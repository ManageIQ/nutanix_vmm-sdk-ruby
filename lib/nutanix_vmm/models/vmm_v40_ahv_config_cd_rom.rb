...
module NutanixVmm
  ...
  class VmmV40AhvConfigCdRom < ApiModelBase
    ...
    attr_accessor :backing_info

    attr_accessor :iso_type
    ...
    def self.openapi_types
      {
        ...
        :'disk_address' => :'VmmV40AhvConfigCdRomAddress',
        :'backing_info' => :'VmmV40AhvConfigVmDisk',
        :'iso_type' => :'VmmV40AhvConfigIsoType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvConfigCdRom` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvConfigCdRom`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'backing_info')
        self.backing_info = attributes[:'backing_info']
      end

      if attributes.key?(:'iso_type')
        self.iso_type = attributes[:'iso_type']
      end
    end
    ...
    def hash
      [tenant_id, ext_id, links, disk_address, backing_info, iso_type].hash
    end
