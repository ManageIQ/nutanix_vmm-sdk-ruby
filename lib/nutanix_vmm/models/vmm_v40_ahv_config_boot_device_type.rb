...
module NutanixVmm
  class VmmV40AhvConfigBootDeviceType
    CDROM = "CDROM".freeze
    DISK = "DISK".freeze
    ...
    def build_from_hash(value)
      return value if VmmV40AhvConfigBootDeviceType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40AhvConfigBootDeviceType"
    end
  end
end
