  ...
  class IamV40AuthnBucketsAccessKey
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::IamV40AuthnBucketsAccessKey`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @access_key_name.to_s.length < 1
        invalid_properties.push('invalid value for "access_key_name", the character length must be great than or equal to 1.')
      end
      ...
      if !@assigned_to.nil? && @assigned_to.to_s.length < 3
        invalid_properties.push('invalid value for "assigned_to", the character length must be great than or equal to 3.')
      end
    ...
    def access_key_name=(access_key_name)
      ...
      if access_key_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "access_key_name", the character length must be great than or equal to 1.'
      end
    ...
    def assigned_to=(assigned_to)
      ...
      if assigned_to.to_s.length < 3
        fail ArgumentError, 'invalid value for "assigned_to", the character length must be great than or equal to 3.'
      end
