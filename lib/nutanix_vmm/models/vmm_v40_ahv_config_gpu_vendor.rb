...
module NutanixVmm
  class VmmV40AhvConfigGpuVendor
    ...
    def build_from_hash(value)
      return value if VmmV40AhvConfigGpuVendor.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40AhvConfigGpuVendor"
    end
  end
end
