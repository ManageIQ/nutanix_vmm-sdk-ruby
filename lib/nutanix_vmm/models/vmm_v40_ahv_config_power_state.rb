...
module NutanixVmm
  class VmmV40AhvConfigPowerState
    ON = "ON".freeze
    OFF = "OFF".freeze
    ...
    def build_from_hash(value)
      return value if VmmV40AhvConfigPowerState.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40AhvConfigPowerState"
    end
  end
end
