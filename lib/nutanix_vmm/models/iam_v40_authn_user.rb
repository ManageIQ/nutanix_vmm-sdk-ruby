  ...
  class IamV40AuthnUser
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::IamV40AuthnUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@middle_initial.nil? && @middle_initial.to_s.length < 1
        invalid_properties.push('invalid value for "middle_initial", the character length must be great than or equal to 1.')
      end
    ...
    def middle_initial=(middle_initial)
      ...
      if middle_initial.to_s.length < 1
        fail ArgumentError, 'invalid value for "middle_initial", the character length must be great than or equal to 1.'
      end
