...
module NutanixVmm
  ...
  class VmmV40AhvConfigGuestToolsInstallConfig < ApiModelBase
    # The list of the application names that are enabled on the guest VM.
    attr_accessor :capabilities

    attr_accessor :credential

    attr_accessor :reboot_preference
    ...
    def self.openapi_types
      {
        :'capabilities' => :'Array<VmmV40AhvConfigNgtCapability>',
        :'credential' => :'VmmV40AhvConfigCredential',
        :'reboot_preference' => :'VmmV40AhvConfigRebootPreference'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvConfigGuestToolsInstallConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvConfigGuestToolsInstallConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reboot_preference')
        self.reboot_preference = attributes[:'reboot_preference']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reboot_preference == o.reboot_preference
    end
    ...
    def hash
      [capabilities, credential, reboot_preference].hash
    end
