...
module NutanixVmm
  class VmmV40EsxiConfigOwnerReferenceEntityType
    ...
    def build_from_hash(value)
      return value if VmmV40EsxiConfigOwnerReferenceEntityType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40EsxiConfigOwnerReferenceEntityType"
    end
  end
end
