...
module NutanixVmm
  ...
  class VmmV40AhvConfigGuestToolsInsertConfig < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvConfigGuestToolsInsertConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvConfigGuestToolsInsertConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_config_only')
        self.is_config_only = attributes[:'is_config_only']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_config_only == o.is_config_only
    end
    ...
    def hash
      [capabilities, is_config_only].hash
    end
