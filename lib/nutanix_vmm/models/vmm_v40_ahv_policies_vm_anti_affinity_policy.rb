...
module NutanixVmm
  ...
  class VmmV40AhvPoliciesVmAntiAffinityPolicy < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'updated_by' => :'VmmV40AhvPoliciesUserReference',
        :'categories' => :'Array<VmmV40AhvPoliciesCategoryReference>',
        :'num_compliant_vms' => :'Integer',
        :'num_non_compliant_vms' => :'Integer',
        :'num_pending_vms' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvPoliciesVmAntiAffinityPolicy` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvPoliciesVmAntiAffinityPolicy`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'num_pending_vms')
        self.num_pending_vms = attributes[:'num_pending_vms']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          num_pending_vms == o.num_pending_vms
    end
    ...
    def hash
      [tenant_id, ext_id, links, name, description, create_time, update_time, created_by, updated_by, categories, num_compliant_vms, num_non_compliant_vms, num_pending_vms].hash
    end
