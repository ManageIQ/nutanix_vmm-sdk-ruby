...
module NutanixVmm
  ...
  class VmmV40AhvPoliciesVmHostAffinityPolicyVmComplianceState < ApiModelBase
    ...
    attr_accessor :associated_categories
    ...
    def self.openapi_types
      {
        ...
        :'compliance_status' => :'VmmV40AhvPoliciesVmHostAffinityPolicyVmComplianceStateAllOfComplianceStatus'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixVmm::VmmV40AhvPoliciesVmHostAffinityPolicyVmComplianceState` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvPoliciesVmHostAffinityPolicyVmComplianceState`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@associated_categories.nil? && @associated_categories.length > 50
        invalid_properties.push('invalid value for "associated_categories", number of items must be less than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@associated_categories.nil? && @associated_categories.length > 50
    ...
    # Custom attribute writer method with validation
    # @param [Object] associated_categories Value to be assigned
    def associated_categories=(associated_categories)
      if associated_categories.nil?
        fail ArgumentError, 'associated_categories cannot be nil'
      end

      if associated_categories.length > 50
        fail ArgumentError, 'invalid value for "associated_categories", number of items must be less than or equal to 50.'
      end

      if associated_categories.length < 1
        fail ArgumentError, 'invalid value for "associated_categories", number of items must be greater than or equal to 1.'
      end
