...
module NutanixVmm
  ...
  class VmmV40AhvPoliciesVmAntiAffinityPolicyVmComplianceState < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixVmm::VmmV40AhvPoliciesVmAntiAffinityPolicyVmComplianceState`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def associated_categories=(associated_categories)
      ...
      if associated_categories.length > 20
        fail ArgumentError, 'invalid value for "associated_categories", number of items must be less than or equal to 20.'
      end
