...
# Unit tests for NutanixVmm::CommonV10ConfigMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NutanixVmm::CommonV10ConfigMessage do
  #let(:instance) { NutanixVmm::CommonV10ConfigMessage.new }

  describe 'test an instance of CommonV10ConfigMessage' do
    it 'should create an instance of CommonV10ConfigMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NutanixVmm::CommonV10ConfigMessage)
    end
  end
