...
# Unit tests for NutanixVmm::CommonV10ConfigFlag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NutanixVmm::CommonV10ConfigFlag do
  #let(:instance) { NutanixVmm::CommonV10ConfigFlag.new }

  describe 'test an instance of CommonV10ConfigFlag' do
    it 'should create an instance of CommonV10ConfigFlag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NutanixVmm::CommonV10ConfigFlag)
    end
  end
