...
# Unit tests for NutanixVmm::StatsApi
...
describe 'StatsApi' do
  ...
  describe 'test an instance of StatsApi' do
    it 'should create an instance of StatsApi' do
      expect(@api_instance).to be_instance_of(NutanixVmm::StatsApi)
    end
  end

  # unit tests for get_disk_stats_by_id_0
  ...
  describe 'get_disk_stats_by_id_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_nic_stats_by_id_0
  ...
  describe 'get_nic_stats_by_id_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_vm_stats_by_id_0
  ...
  describe 'get_vm_stats_by_id_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_vm_stats_0
  ...
  describe 'list_vm_stats_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
